...
int task_create(struct task_exec_info *info, void *arg, unsigned int prio);
...
/* Module exec interface, to populate information
 * about executable files.
 */

#define EXEC_TYPE_BIN  (0) /* flat binary */
#define EXEC_TYPE_BFLT (1) /* bFLT binary */
...
struct module {
    ...
    struct module_operations {
        ...
        int (*exe)(struct fnode *fno, void *arg, struct task_exec_info *info);
...
/* Secure allocator interface for kernel structures */
