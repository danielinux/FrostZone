...
#define RCC_APB1HRSTR      (*(volatile uint32_t *)(STM32H563_RCC_BASE + 0x078U))
#define RCC_APB2RSTR       (*(volatile uint32_t *)(STM32H563_RCC_BASE + 0x07CU))
#define RCC_APB3RSTR       (*(volatile uint32_t *)(STM32H563_RCC_BASE + 0x080U))
#define RCC_APB1LENR       (*(volatile uint32_t *)(STM32H563_RCC_BASE + 0x09CU))
#define RCC_APB1HENR       (*(volatile uint32_t *)(STM32H563_RCC_BASE + 0x0A0U))
...
#define RCC_CCIPR1         (*(volatile uint32_t *)(STM32H563_RCC_BASE + 0x0D8U))
...
#define RCC_APB_PRESCALER_DIV_2    0x4U
...
#define RCC_APB2ENR_USBFSEN BIT(24)
#define RCC_APB2RSTR_USBFSRST BIT(24)

#define RCC_CCIPR1_USART3SEL_SHIFT 6U
#define RCC_CCIPR1_USART3SEL_MASK  (0x7U << RCC_CCIPR1_USART3SEL_SHIFT)
#define RCC_CCIPR1_USART3SEL_PCLK1 (0x0U << RCC_CCIPR1_USART3SEL_SHIFT)
#define RCC_CCIPR1_USART3SEL_PLL2Q (0x1U << RCC_CCIPR1_USART3SEL_SHIFT)
#define RCC_CCIPR1_USART3SEL_PLL3Q (0x2U << RCC_CCIPR1_USART3SEL_SHIFT)
#define RCC_CCIPR1_USART3SEL_HSI   (0x3U << RCC_CCIPR1_USART3SEL_SHIFT)
#define RCC_CCIPR1_USART3SEL_CSI   (0x4U << RCC_CCIPR1_USART3SEL_SHIFT)
#define RCC_CCIPR1_USART3SEL_LSE   (0x5U << RCC_CCIPR1_USART3SEL_SHIFT)

#define RCC_CCIPR4_USBFSSEL_SHIFT 4U
#define RCC_CCIPR4_USBFSSEL_MASK  (0x3U << RCC_CCIPR4_USBFSSEL_SHIFT)
#define RCC_CCIPR4_USBFSSEL_HSI48 (0x3U << RCC_CCIPR4_USBFSSEL_SHIFT)
...
#define PWR_USBSCR          (*(volatile uint32_t *)(PWR_BASE + 0x038U))
#define PWR_USBSCR_USB33DEN BIT(24)
#define PWR_USBSCR_USB33SV  BIT(25)
#define PWR_VMSR            (*(volatile uint32_t *)(PWR_BASE + 0x03CU))
#define PWR_VMSR_USB33RDY   BIT(24)
