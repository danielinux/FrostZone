...
static void sau_init(void)
{
    ...
    /* Enable MemFault, BusFault and UsageFault for the non-secure world */
    SHCSR |= SHCSR_MEMFAULTENA | SHCSR_BUSFAULTENA | SHCSR_USGFAULTENA;
    SHCSR_NS |= SHCSR_MEMFAULTENA | SHCSR_BUSFAULTENA | SHCSR_USGFAULTENA;

    SCB_AIRCR = 0x05FA0000 | AIRCR_BFHFNMINS;
