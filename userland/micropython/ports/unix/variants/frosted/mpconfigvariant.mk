...
# Read Kconfig options from the frosted build
FROSTED_KCONFIG ?= $(abspath $(VARIANT_DIR)/../../../../kconfig/.config)
-include $(FROSTED_KCONFIG)

ifeq ($(MICROPYTHON_UNIX_FFI),y)
MICROPY_PY_FFI = 1
else
MICROPY_PY_FFI = 0
endif

ifeq ($(MICROPYTHON_THREAD),y)
MICROPY_PY_THREAD = 1
else
MICROPY_PY_THREAD = 0
endif
